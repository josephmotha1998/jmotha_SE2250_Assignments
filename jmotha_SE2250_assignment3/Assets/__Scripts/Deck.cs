...
public class Deck : MonoBehaviour {
    ...
    static public void MixDeck(ref List<Card> unmixedDeck)
    {
        List<Card> mixedDeck = new List<Card>();
        int playercard;
        while (unmixedDeck.Count > 0)
        {
            playercard = Random.Range(0, unmixedDeck.Count);
            mixedDeck.Add(unmixedDeck[playercard]);
            unmixedDeck.RemoveAt(playercard);
        }
        unmixedDeck = mixedDeck;
    }
